...
| RCD-008-004 | Keep model-assisted work proposal-only; deterministic validation alone may accept contract output, and no model call is part of MISSION-008. | Proposed | RC-070 through RC-074; model adversarial fixtures |
...
| RCD-008-010 | Carry IRG-008-001 and IRG-008-002 into separately unauthorized Roadmap Phase 5 planning without changing frozen IR v0.1. | Proposed | `evidence/unresolved-ir-gaps.json` |
