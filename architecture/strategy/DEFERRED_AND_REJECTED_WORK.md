...
|---|---|---|---|---|---|
| DFR-001 | Fifth provider adapter | `DEFERRED` | Adapter breadth would optimize the already-strong middle of the pipeline while intent, evaluation, and repair remain missing | Remaining 4B engineering is owner-Accepted; a provider adds distinct evidence that affects canonical design; owner authorizes scope | Phase 5 or later, after remaining 4B engineering |
| DFR-002 | Broad UI work | `DEFERRED` | A UI before stable headless behavior risks hidden semantics and duplicated state | Remaining 4B engineering plus owner Accept of headless requirements/evaluation/repair; Phases 5–7 provide any additional required APIs/evidence; one shared project model and accessibility gates are ratified | Phase 8 |
| DFR-003 | Live provider calls | `DEFERRED` | Lowering is certified offline; execution introduces network, cost, provider-returned state, partial failure, and side effects | Remaining 4B engineering plus owner Accept, and Phase 6 permission/execution contract is accepted | Phase 6 |
...
| DFR-007 | Persistence and background jobs | `DEFERRED` | Current sinks are local outputs, not durable product state; no job/idempotency contract exists | Remaining 4B headless remainder plus owner Accept, plus project, job, cancellation, retention, and recovery contracts | Phase 8 |
...
- MISSION-021 implemented OQ-008-001/002/006 (OAR-015 Accepted 2026-08-23). MISSION-022 implemented OQ-008-003/005/010 (OAR-016 Accepted 2026-08-24). MISSION-023 mapped numbered/constraint `plain_language_v0` records (OAR-017 Accepted 2026-08-24). MISSION-024 remaining Phase 4B inventory (OAR-018 Accepted 2026-08-28) records outstanding independent architecture/security review and evaluation/repair product bar; does not promote CERTIFIED. MISSION-025 same-host PARTIAL-slice review (OAR-019 Accepted 2026-08-28) records same-host architecture/security review of the current PARTIAL compiler slice; does not promote CERTIFIED. MISSION-026 independent-person pack (OAR-020 Ready, owner + second person, not 4B-exit certification) records a plain-language architecture/security pack of the current PARTIAL slice at SHA `2831cda`; does not promote CERTIFIED. MISSION-028 skip-cert law (OAR-022 Ready) amends Phase 5-implementation and Phase 6–9 entry: independent 4B-exit certification and peer-review CERTIFIED promotion of the requirements compiler are not a gate. MISSION-027 eval/repair product bar is implemented (OAR-021 Ready); the product surface is not CERTIFIED / not Phase 4B exit. Remaining unauthorized 4B engineering: the 008 SUCCESS/PARTIAL join. Remaining unauthorized: OQ-008-004/007/008/009 lock, full 008 compiler, M3, freeform NLP, CERTIFIED compiler promotion, full Phase 4B exit.
- OAR-006 certified the narrow offline deterministic compile/security evaluator and bounded instruction-append repair (budgets `{0,1,2}`, `EVR-SEC-0001`). MISSION-027 implements the rubric/dataset engine, baseline comparison, scoring aggregation, and production regression gate (OAR-021 Ready). The product surface is not CERTIFIED / not Phase 4B exit. The fake-adapter oracle slice stays CERTIFIED.
- OAR-006 accepted a narrow offline structured+fake headless boundary (fake adapter only, no network). OAR-007 Accepted 2026-08-14 certifies MISSION-013 M1 constrained prose intake (`plain_language_v0`). OAR-008 Accepted 2026-08-14 certifies MISSION-014 offline fake `fake-suggester-v0` M2 sidecar; proposals are sidecar evidence only and are not mapped to IR. MISSION-015 residual evidence (OAR-009 Accepted 2026-08-22) adds PEP 517 clean-install, installed-package consumer matrix, and operational resource ceilings for the fake path — not a benchmark. MISSION-016 (OAR-010 Accepted 2026-08-21) lifted the 008 rule engine into production for canonical records only. Still unauthorized: live model-assisted suggestion, freeform NLP, live M2, M3 / Simple Mode UI, no full 008 authoring-envelope production compiler; OQ-008-001/002/006 implemented (OAR-015 Accepted 2026-08-23); OQ-008-003/005/010 implemented (OAR-016 Accepted 2026-08-24); OQ-008-004/007/008/009 locked-not-built; MISSION-023 numbered/constraint mapping (OAR-017 Accepted 2026-08-24); MISSION-024 remaining Phase 4B inventory (OAR-018 Accepted 2026-08-28); full 008, CERTIFIED, M3, and full Roadmap Phase 4B exit remain unauthorized; do not claim production-hardened full Phase 4B engines.
