...
- MISSION-017 added file/api envelope producers for canonical assembly (`produce_requirements`, `compile_requirements_input`); remaining unauthorized: simple/developer/prs/prose producers; OQs open; no full 008 compiler; no M3.
