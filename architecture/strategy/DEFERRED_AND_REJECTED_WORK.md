...
- MISSION-017 added file/api envelope producers for canonical assembly (`produce_requirements`, `compile_requirements_input`); MISSION-018 added simple/developer envelope producers; MISSION-019 added structured prs envelope producer (PRS language/grammar still DEFERRED per `PRS_DISPOSITION.md`); remaining unauthorized: authoring-prose producers; OQs open; no full 008 compiler; no M3.
