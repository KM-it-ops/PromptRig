...
- No production intent-to-IR compiler exists beyond OAR-005/OAR-006 structured profiles (`structured_minimal_v0`, `structured_developer_v0`) plus OAR-007 M1 constrained `plain_language_v0` intake plus MISSION-016 shared 008 contract-rule engine for canonical records only (`compile_requirements`); remaining unauthorized: no full 008 authoring-envelope production compiler; OQs open.
