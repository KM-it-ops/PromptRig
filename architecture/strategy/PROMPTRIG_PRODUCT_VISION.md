...
A fifth provider adapter is prohibited until remaining Phase 4B engineering is owner-Accepted after the fake-adapter prototype. The current four conformance targets are fake, OpenAI, Anthropic, and Gemini.
...
- remaining Phase 4B engineering and owner Accept of the headless requirements, evaluation, repair, evidence, library, CLI, packaging, and consumer remainder the product consumes; peer-review CERTIFIED promotion of the requirements compiler is not that gate;
