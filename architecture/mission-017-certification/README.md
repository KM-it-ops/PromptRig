...
**Status:** OAR-011 Accepted 2026-08-22. OAR-010 remains Accepted. OAR-009 remains Ready (not Accepted).
**Baseline:** local `main` @ `ae625a4` (acceptance after residual polish).
...
- Not full MISSION-008 production compiler (no freeform NLP; no Simple/Developer/PRS producers — those require a later campaign).
...
- OAR-011 Accepted. OAR-009 remains Ready (not Accepted).
