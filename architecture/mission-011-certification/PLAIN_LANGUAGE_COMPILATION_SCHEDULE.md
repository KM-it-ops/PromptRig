...
2. **M1 (implemented, OAR-007 Accepted 2026-08-14 — MISSION-013):** Headless `plain_language_v0` constrained prose intake (see `architecture/mission-013-certification/PLAIN_LANGUAGE_V0_GRAMMAR.md`); emits `structured_minimal_v0` records subject to MISSION-008 deterministic validation before IR. M2 and M3 remain future.
