"""Regenerate src/proofhouse/compiler/typescript/*.ts from the vendored contract schemas.
...
from proofhouse.compiler.codegen.typescript import generate_all  # noqa: E402
from proofhouse.compiler import paths as compiler_paths  # noqa: E402


def main() -> int:
    output_dir = REPO_ROOT / "src" / "proofhouse" / "compiler" / "typescript"
